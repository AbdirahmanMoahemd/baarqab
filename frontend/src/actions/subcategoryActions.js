...
export const createSubCategory = ( name, category) => async (
  dispatch,
  getState
) => {
  try {
    ...
    const config = {
      ...
      const { data } = await axios.post(`/api/subcategory`, { name, category}, config)
...
export const updateSubCategory = (subcategory) => async (
  dispatch,
  getState
) => {
  try {
    ...
    headers: {
      ...
      const { data } = await axios.put(`/api/subcategory/${subcategory._id}`, subcategory, config)
